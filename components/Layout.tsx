    ...
    <div className={`sf-layout ${isLockdown ? 'lockdown-active' : ''}`}>
        ...
        <div className="sf-container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <div className="mono" style={{ 
              ...
              transform: isLockdown ? 'scale(1.1) rotate(12deg)' : 'none',
              transition: '0.5s'
            }}>SF</div>
            <div>
              <h1 style={{ margin: 0, fontSize: '1.25rem', fontWeight: 900, textTransform: 'uppercase', fontStyle: 'italic', letterSpacing: '-0.05em' }}>
                SentinelFlow <span style={{ color: isLockdown ? '#fecdd3' : '#06b6d4' }}>Auditor</span>
              </h1>
              <p className="mono" style={{ margin: 0, fontSize: '9px', fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', opacity: 0.6 }}>
      ...
      <footer style={{ 
        ...
        <div className="sf-container mono" style={{ display: 'flex', justifyContent: 'space-between', fontWeight: 700 }}>
          <span>&copy; 2024 AB LABS // SENTINEL_V2.4</span>
